...
print(result)"""
    ...
    # Execute submission directly (not async)
    print(
        "Executing submission directly (expecting Judge0 Internal Error -> Local Fallback)..."
    )
    try:
    ...
    elif submission.judge0_raw and "Internal Error" in str(submission.judge0_raw):
